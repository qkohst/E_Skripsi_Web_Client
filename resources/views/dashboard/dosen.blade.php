...
@section('title')
<title>E-Skripsi | Dosen Dashboard</title>
@endsection
@section('content')
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-9">
              ...
              <a href="https://www.youtube.com/watch?v=lDdH9RSFWKc" target="_black" class="btn btn-outline-light btn-sm mt-2"><span class="left"><i class="la la-play"></i>
                </span>PANDUAN</a>
            </div>
