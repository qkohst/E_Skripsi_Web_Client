...
<head>
  <meta charset="utf-8" />
  <title>E-Skripsi | Berita Acara Bimbingan Skripsi</title>
...
<body>
  ...
  <div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
      ...
      <tr class="top">
        <td colspan="5" style="text-align: center">
          <strong>BERITA ACARA BIMBINGAN SKRIPSI</strong><br>
    ...
    <table style="padding-top: 5px;">
      ...
      <tr class="item">
        ...
        <td class="number">{{$bimbingan_1['tanggal_pengajuan_bimbingan_skripsi']}}</td>
        <td>{{$bimbingan_1['topik_bimbingan_skripsi']}}</td>
        <td>{{$bimbingan_1['status_persetujuan_bimbingan_skripsi']}}</td>
        <td></td>
      </tr>
      @endforeach
    </table>
  ...
  <div class="invoice-box">
    ...
    <table style="padding-top: 5px;">
      ...
      <tr class="item">
        <td class="number">{{$no}}</td>
        <td class="number">{{$bimbingan_2['tanggal_pengajuan_bimbingan_skripsi']}}</td>
        <td>{{$bimbingan_2['topik_bimbingan_skripsi']}}</td>
        <td>{{$bimbingan_2['status_persetujuan_bimbingan_skripsi']}}</td>
        <td></td>
      </tr>
      @endforeach
    </table>
