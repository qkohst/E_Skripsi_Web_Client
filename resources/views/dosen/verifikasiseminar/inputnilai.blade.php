        ...
        <div class="card-body">
          ...
          <div class="default-tab mt-2">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a class="nav-link " data-toggle="tab" href="#verifikasi">Verifikasi Hasil Seminar</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="inputNilai">
                <div class="pt-4">
                  ...
                  <form class="mt-3" action="{{ route('verifikasiseminar.post_nilai', $data_seminar['id']) }}" method="post">
                    {{ method_field('PATCH') }}
                    @csrf
                    <h5>A. Proses Bimbingan <small><i>(Khusus Dosen Pembimbing)</i></small></h5>
                    @if($data_nilai['jabatan_dosen_seminar_proposal'] == 'Pembimbing 1' || $data_nilai['jabatan_dosen_seminar_proposal'] == 'Pembimbing 2')
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          <label class="col-sm-7 col-form-label col-form-label">Ketekunan</label>
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_a1_hasil_seminar_proposal" value="{{$data_nilai['nilai_a1_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_a2_hasil_seminar_proposal" value="{{$data_nilai['nilai_a2_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_a3_hasil_seminar_proposal" value="{{$data_nilai['nilai_a3_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    @elseif($data_nilai['jabatan_dosen_seminar_proposal'] == 'Penguji 1' || $data_nilai['jabatan_dosen_seminar_proposal'] == 'Penguji 2')
                    <fieldset disabled>
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-7 col-form-label col-form-label">Ketekunan</label>
                            <div class="col-sm-5">
                              <input type="number" class="form-control" name="nilai_a1_hasil_seminar_proposal" value="{{$data_nilai['nilai_a1_hasil_seminar_proposal']}}">
                            </div>
                          </div>
                        </div>
                        <div class="form-group col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-7 col-form-label col-form-label">Adab</label>
                            <div class="col-sm-5">
                              <input type="number" class="form-control" name="nilai_a2_hasil_seminar_proposal" value="{{$data_nilai['nilai_a2_hasil_seminar_proposal']}}">
                            </div>
                          </div>
                        </div>
                        <div class="form-group col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-7 col-form-label col-form-label">Kemandirian</label>
                            <div class="col-sm-5">
                              <input type="number" class="form-control" name="nilai_a3_hasil_seminar_proposal" value="{{$data_nilai['nilai_a3_hasil_seminar_proposal']}}">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b1_hasil_seminar_proposal" value="{{$data_nilai['nilai_b1_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b2_hasil_seminar_proposal" value="{{$data_nilai['nilai_b2_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b3_hasil_seminar_proposal" value="{{$data_nilai['nilai_b3_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b4_hasil_seminar_proposal" value="{{$data_nilai['nilai_b4_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b5_hasil_seminar_proposal" value="{{$data_nilai['nilai_b5_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b6_hasil_seminar_proposal" value="{{$data_nilai['nilai_b6_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_b7_hasil_seminar_proposal" value="{{$data_nilai['nilai_b7_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_c1_hasil_seminar_proposal" value="{{$data_nilai['nilai_c1_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_c2_hasil_seminar_proposal" value="{{$data_nilai['nilai_c2_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-5">
                            <input type="number" class="form-control" name="nilai_c3_hasil_seminar_proposal" value="{{$data_nilai['nilai_c3_hasil_seminar_proposal']}}" required>
                          </div>
                        </div>
                      </div>
                    </div>
